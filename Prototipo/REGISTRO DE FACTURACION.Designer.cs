...
namespace Prototipo
{
    partial class Form6
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtNitDui = new System.Windows.Forms.TextBox();
            ...
            this.label2.Text = "Registro de Facturación";
            ...
            this.label4.Text = "NIT / DUI:";
            this.label4.Click += new System.EventHandler(this.label4_Click);
            // 
            // txtNitDui
            // 
            this.txtNitDui.Location = new System.Drawing.Point(614, 133);
            this.txtNitDui.Name = "txtNitDui";
            this.txtNitDui.Size = new System.Drawing.Size(179, 22);
            this.txtNitDui.TabIndex = 7;
            // 
            // txtNombreCliente
            // 
            this.txtNombreCliente.Location = new System.Drawing.Point(870, 133);
            ...
            // txtDireccion
            // 
            this.txtDireccion.Location = new System.Drawing.Point(1140, 133);
            ...
            this.label6.Location = new System.Drawing.Point(1136, 108);
            ...
            // txtCuenta
            // 
            this.txtCuenta.Location = new System.Drawing.Point(1384, 133);
            this.txtCuenta.Name = "txtCuenta";
            this.txtCuenta.Size = new System.Drawing.Size(149, 22);
            this.txtCuenta.TabIndex = 13;
            this.txtCuenta.TextChanged += new System.EventHandler(this.textBox5_TextChanged);
            // 
            // label7
            // 
            this.label7.AutoSize = true;
            this.label7.Font = new System.Drawing.Font("Microsoft Sans Serif", 10.8F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.label7.Location = new System.Drawing.Point(1380, 108);
            this.label7.Name = "label7";
            this.label7.Size = new System.Drawing.Size(108, 22);
            this.label7.TabIndex = 12;
            this.label7.Text = "Cuenta de:";
            ...
            this.button4.Click += new System.EventHandler(this.btnImprimir_Click);
            // 
            // btnNuevo
            // 
            ...
            // dateTimePicker1
            // 
            this.dateTimePicker1.Location = new System.Drawing.Point(339, 133);
            ...
            this.splitter1.Size = new System.Drawing.Size(297, 640);
            ...
            this.dataGridView1.Location = new System.Drawing.Point(339, 238);
            ...
            // textBox1
            // 
            this.textBox1.Location = new System.Drawing.Point(871, 210);
            ...
            this.label15.Location = new System.Drawing.Point(866, 178);
            ...
            // textBox2
            // 
            this.textBox2.Location = new System.Drawing.Point(615, 210);
            ...
            // textBox3
            // 
            this.textBox3.Location = new System.Drawing.Point(341, 210);
            ...
            // textBox4
            // 
            this.textBox4.Location = new System.Drawing.Point(1384, 210);
            ...
            this.label18.Location = new System.Drawing.Point(1380, 175);
            ...
            // textBox5
            // 
            this.textBox5.Location = new System.Drawing.Point(1140, 203);
            ...
            this.label19.Location = new System.Drawing.Point(1136, 178);
            ...
            this.Controls.Add(this.txtNitDui);
        ...
        // Fix for CS1061: Ensure the controls are properly cast to their expected types.  
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection conexión = new SqlConnection("Server=localhost\\SQLEXPRESS;Database=prototipo;Trusted_Connection=True;"))
                {
                    ...
                    string query = "INSERT INTO Facturacion (Fecha, NIT_DUI, NombreCliente, Direccion, Cuenta, Cantidad, Descripcion, Precio, PrecioTotal, TotalFinal) " +
                                   "VALUES (@Fecha, @NIT_DUI, @NombreCliente, @Direccion, @Cuenta, @Cantidad, @Descripcion, @Precio, @PrecioTotal, @TotalFinal)";

                    using (SqlCommand comand = new SqlCommand(query, conexión))
                    {
                        // Ensure the controls are properly cast to their expected types
                        comand.Parameters.AddWithValue("@Fecha", dateTimePicker1.Value.Date);
                        comand.Parameters.AddWithValue("@NIT_DUI", txtNitDui.Text.Trim());
                        comand.Parameters.AddWithValue("@NombreCliente", txtNombreCliente.Text.Trim());
                        comand.Parameters.AddWithValue("@Direccion", txtDireccion.Text.Trim());
                        comand.Parameters.AddWithValue("@Cuenta", txtCuenta.Text.Trim());
                        comand.Parameters.AddWithValue("@Cantidad", Convert.ToInt32(textBox3.Text.Trim())); // Corrected reference to textBox3
                        comand.Parameters.AddWithValue("@Descripcion", textBox2.Text.Trim()); // Corrected reference to textBox2
                        comand.Parameters.AddWithValue("@Precio", decimal.Parse(textBox1.Text.Trim())); // Corrected reference to textBox1
                        comand.Parameters.AddWithValue("@PrecioTotal", decimal.Parse(textBox1.Text.Trim()) * int.Parse(textBox3.Text.Trim())); // Corrected references
                        comand.Parameters.AddWithValue("@TotalFinal", decimal.Parse(textBox1.Text.Trim()) * int.Parse(textBox3.Text.Trim())); // Corrected references
        ...
        private System.Windows.Forms.TextBox txtNitDui;
        ...
        private object dateTimePickerFecha;
        private object txtNIT_DUI;
