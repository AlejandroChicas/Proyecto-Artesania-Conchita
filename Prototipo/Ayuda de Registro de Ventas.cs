...
namespace Prototipo
{
    public partial class Ayuda_de_Registro_de_Ventas : Form
    {
        public Ayuda_de_Registro_de_Ventas()
        {
            InitializeComponent();
        }

        private void Ayuda_de_Registro_de_Ventas_Load(object sender, EventArgs e)
        {
            try
            {
