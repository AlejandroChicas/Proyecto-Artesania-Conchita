...
namespace Prototipo
{
    public partial class Ayuda_de_Registro_de_Cliente : Form
    {
        public Ayuda_de_Registro_de_Cliente()
        {
            InitializeComponent();
        }

        private void Ayuda_de_Registro_de_Cliente_Load(object sender, EventArgs e)
        {
            try
                {
